...
using SchoolTripPlannerUWP.Core.Exceptions;
using System;
...
namespace SchoolTripPlannerUWP.Core.Repository
{
    public class GenericRepository : IGenericRepository
    {
        ...
        private HttpClient CreateHttpClient(string authToken)
        {
            ...
            {
                httpClient.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("key", authToken);
            }
