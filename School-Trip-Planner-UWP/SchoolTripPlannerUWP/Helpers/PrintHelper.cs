...
namespace SchoolTripPlannerUWP.Helpers
{
    public class PrintHelper
    {
        ...
        {
            get { return scenarioPage.FindName("PrintCanvas") as Canvas; }
        }
        ...
        public virtual void PreparePrintContent(Page page)
        {
            ...
            {
                firstPage = page;
                //                elementToPrint = (FrameworkElement) firstPage.FindName(elementToPrint.Name);
                FrameworkElement header = (FrameworkElement)firstPage.FindName("Header");
                //                StackPanel header = (StackPanel) firstPage.FindName(elementToPrint);
        ...
        protected virtual RichTextBlockOverflow AddOnePrintPreviewPage(RichTextBlockOverflow lastRTBOAdded, PrintPageDescription printPageDescription)
        {
            ...
            if (lastRTBOAdded == null)
            {
                ...
                FrameworkElement footer = (FrameworkElement) page.FindName("Footer");
            ...
            FrameworkElement printableArea = (FrameworkElement) page.FindName("PrintableArea");
