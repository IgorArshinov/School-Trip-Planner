...
namespace SchoolTripPlannerUWP.Services
{
    public class NavigationServiceEx : INavigationServiceEx
    {
        ...
        public bool NavigateAsync(string pageKey, object parameter = null, NavigationTransitionInfo infoOverride = null)
        {
            Type page;
            lock (_pages)
            {
        ...
        public void Frame_NavigationFailed(object sender, NavigationFailedEventArgs e) => NavigationFailed?.Invoke(sender, e);
        public void Frame_Navigated(object sender, NavigationEventArgs e) => Navigated?.Invoke(sender, e);
        public void Frame_Navigating(object sender, NavigatingCancelEventArgs e) => Navigating?.Invoke(sender, e);
    }
}
